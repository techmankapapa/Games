  ...
  <div class="game-body">
    <div class="screen-wrap">
      <div class="cabinet-bezel">
        <iframe src="{source}" title="{title}" allow="autoplay"></iframe>
      </div>
    </div>
    ...
    <aside class="side-panel">
      <div class="panel-block">
        ...
        <p class="hint">This game runs in an embedded frame we don't control, so it can't hand us your score automatically. Type in the number shown on screen and save it here — it stays on this device under your guest tag.</p>
      </div>
